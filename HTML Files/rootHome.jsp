...
<body>
    <div class="container">
        ...
        <div>
            <hr> 
            <p class="black-text">You are connected to the Project 4 Enterprise System database as a <strong>root-level</strong> user. <br> Please enter any SQL query or update command in the box below.</p>
            <hr>
            <form id="sqlForm" action="rootUser" method="post">
    ...
    <script>
        document.getElementById("executeBtn").addEventListener("click", function(event) {
            ...
            xhr.open("POST", "rootUser", true); // Open POST request to rootUser servlet
